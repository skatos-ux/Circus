...
public class MetaSequenceContainer implements Serializable
	...
	public MetaSequenceContainer ()
		...
		Media media1 = new Media ( "Media 1", Duration.between ( start, end ), TypeMedia.PICTURE );
		Media media2 = new Media ( "Media 2", Duration.between ( start, end ), TypeMedia.VIDEO );
		Media media3 = new Media ( "Media 3", Duration.between ( start, end ), TypeMedia.PICTURE );
